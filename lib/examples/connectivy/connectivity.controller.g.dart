...
part of 'connectivity.controller.dart';
...
mixin _$ConnectivityController on _ConnectivityControllerBase, Store {
  final _$connectivityStreamAtom =
      Atom(name: '_ConnectivityControllerBase.connectivityStream');
